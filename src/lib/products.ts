...
export const categories = [
  { name: "Jerseys", image: img("photo-1517466787929-bc90951d0974") },
  ...
  { name: "Caps", image: img("photo-1588850561407-ed78c282e89b") },
] as const;
...
const cats: Product["category"][] = [
  "Jerseys", "Hoodies", "Sweatshirts", "Varsity Jackets", "Uniforms", "Kaftans", "Caps",
];

const names: Record<Product["category"], string[]> = {
  Jerseys: ["Kosisi Home Jersey", "Noir Away Kit", "Legacy Retro Jersey", "Elite Match Jersey"],
